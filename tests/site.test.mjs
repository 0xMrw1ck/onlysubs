...
test('static website has valid local links and no local-editor API or tracking integration',async()=>{
 ...
 assert.match(index,/github\.com\/0xMrw1ck\/onlysubs-updates\/releases\/download\/v0\.6\.0\/onlysubs-0\.6\.0-setup-x64\.exe/)
 assert.match(index,/No subscription/)
